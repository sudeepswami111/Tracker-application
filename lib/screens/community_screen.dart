...
class _PremiumChallengeCard extends StatelessWidget {
  ...
  const _PremiumChallengeCard({
    required this.title, required this.progress, required this.total,
    required this.unit, required this.gradient, required this.icon, required this.participants,
  });
                ...
                Column(
                  ...
                  children: [
                      ...
                      children: [
                        Row(
                          children: [
                            ...
                            Text(participants, style: const TextStyle(color: Colors.white70, fontSize: 13, fontWeight: FontWeight.w600)),
                          ],
                        ),
                        Text('$progress / $total $unit', style: const TextStyle(color: Colors.white, fontWeight: FontWeight.bold, fontSize: 14)),
                      ],
                    ),
                    ...
                    ClipRRect(
                      ...
                      child: Stack(
                        children: [
                          Container(height: 8, color: Colors.black.withValues(alpha: 0.2)),
